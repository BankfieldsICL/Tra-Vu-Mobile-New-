...
/// To switch to a different provider, implement [LocationServiceInterface]
/// and register the new class via GetX instead of this one.
class OsmLocationService implements LocationServiceInterface {
  ...
  static const String _userAgent = 'TraVuDriverApp/1.0 (contact@tra-vu.com)';
  ...
  /// Converts a [Place] to a [LocationModel] for use in existing job/trip data.
